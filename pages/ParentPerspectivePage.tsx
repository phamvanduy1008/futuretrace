      ...
      <header className="sticky top-0 z-30 bg-white/95 backdrop-blur-md border-b border-slate-200/90 shadow-sm px-4 sm:px-8 py-3.5 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="px-2.5 py-0.5 rounded-full bg-blue-50 text-blue-700 font-bold text-xs uppercase tracking-wider border border-blue-200">
                Thấu Kính Phụ Huynh
              </span>
            </div>
            <p className="text-xs sm:text-sm text-slate-500 hidden sm:block">
              Báo cáo định hướng tương lai thấu hiểu & đồng hành cùng con
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          <button
            ...
            className={`flex items-center gap-1.5 px-3.5 py-2 rounded-xl border text-xs sm:text-sm font-bold transition-all ${
              isLargeFont
          ...
          >
            ...
            <span className="hidden sm:inline">
              {isLargeFont ? "Cỡ chữ lớn: Đang bật" : "Cỡ chữ lớn"}
            </span>
          ...
          <button
            onClick={handlePrint}
            className="hidden sm:flex items-center gap-1.5 px-3.5 py-2 rounded-xl border border-slate-200 bg-white hover:bg-slate-50 text-slate-700 text-xs sm:text-sm font-bold transition-all"
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-6 sm:py-10 space-y-7">
        ...
        <div className="bg-white rounded-[2rem] p-6 sm:p-8 border-2 border-slate-100 shadow-[0_15px_30px_-5px_rgba(0,0,0,0.03)] space-y-4">
          <div className="flex flex-wrap items-center justify-between gap-2">
            <div className="flex items-center gap-2 text-rose-600 font-bold text-xs sm:text-sm uppercase tracking-wider">
              <Heart size={20} weight="fill" />
              <span>Thư gửi Ba Mẹ / Quý Phụ Huynh</span>
            </div>
            <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-slate-100 text-slate-700 text-xs sm:text-sm font-bold">
              <Tag size={14} />
              {report.categoryTag}
            </span>
          </div>
          ...
          <p className="text-slate-700 leading-relaxed italic bg-slate-50 p-5 rounded-2xl border border-slate-100 text-sm sm:text-base">
          ...
          <div className="flex flex-wrap items-center gap-4 text-xs sm:text-sm text-slate-500 pt-2 border-t border-slate-100">
            <span className="flex items-center gap-1.5 font-medium text-emerald-700">
              <CalendarCheck size={18} /> Dữ liệu đồng bộ theo kịch bản cá nhân của con
            </span>
            <span className="flex items-center gap-1.5 font-medium text-blue-700">
              <Users size={18} /> Ngôn ngữ ấm áp, gần gũi với gia đình Việt
            </span>
          </div>
        </div>
        ...
        <div className="space-y-6">
          ...
          <section className="bg-white rounded-[2rem] p-6 sm:p-8 border-2 border-slate-100 shadow-[0_15px_30px_-5px_rgba(0,0,0,0.03)] space-y-5">
            <div className="flex items-center gap-3.5">
              <div className="w-13 h-13 rounded-2xl bg-slate-50 border border-slate-100 text-blue-600 flex items-center justify-center shrink-0 p-3">
            ...
            <div className="bg-slate-50 rounded-2xl p-5 border border-slate-100 space-y-3">
              <div className="flex flex-col sm:flex-row sm:items-baseline justify-between gap-1.5">
                ...
                <span className="text-lg sm:text-xl font-bold text-blue-700 font-display">
                  {report.financialInvestment.monthlyEstimate}
                </span>
              </div>
              <div className="flex flex-col sm:flex-row sm:items-baseline justify-between gap-1.5 pt-3 border-t border-slate-200">
                <span className="text-sm sm:text-base font-semibold text-slate-600">
            ...
            <div className="p-4 sm:p-5 rounded-2xl bg-amber-50/70 border border-amber-200/80 text-sm sm:text-base text-amber-950 flex items-start gap-3">
              <Lightbulb size={22} weight="fill" className="text-amber-600 shrink-0 mt-0.5" />
          ...
          <section className="bg-white rounded-[2rem] p-6 sm:p-8 border-2 border-slate-100 shadow-[0_15px_30px_-5px_rgba(0,0,0,0.03)] space-y-5">
            <div className="flex items-center gap-3.5">
              <div className="w-13 h-13 rounded-2xl bg-slate-50 border border-slate-100 text-emerald-600 flex items-center justify-center shrink-0 p-3">
            ...
            <div className="bg-slate-50 rounded-2xl p-5 border border-slate-100 space-y-3.5">
              <div className="flex flex-col sm:flex-row sm:items-baseline justify-between gap-1.5">
                ...
                <span className="text-lg sm:text-xl font-bold text-emerald-700 font-display">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5 pt-3 border-t border-slate-200">
                ...
                <div className="bg-white p-4 rounded-xl border border-slate-200">
                  <span className="text-xs uppercase font-bold text-slate-500 block">Thu nhập sau 3 - 5 năm:</span>
            ...
            <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200 text-sm sm:text-base text-slate-600 flex items-start gap-3">
              <Coins size={22} weight="fill" className="text-emerald-600 shrink-0 mt-0.5" />
              <span className="leading-relaxed">
                <strong className="text-slate-900 font-semibold">Ý nghĩa thực tế:</strong> Cha mẹ chỉ cần trợ lực tài chính trong giai đoạn đầu; khi con đã có kinh nghiệm và nhận bằng, con hoàn toàn tự nuôi sống bản thân.
              </span>
            </div>
          </section>
          ...
          <section className="bg-white rounded-[2rem] p-6 sm:p-8 border-2 border-slate-100 shadow-[0_15px_30px_-5px_rgba(0,0,0,0.03)] space-y-5">
            <div className="flex items-center gap-3.5">
              <div className="w-13 h-13 rounded-2xl bg-slate-50 border border-slate-100 text-amber-600 flex items-center justify-center shrink-0 p-3">
            ...
            <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200 text-sm sm:text-base text-slate-600 leading-relaxed">
              <strong className="text-slate-900 font-semibold">Nhu cầu xã hội:</strong>{" "}
          ...
          <section className="bg-white rounded-[2rem] p-6 sm:p-8 border-2 border-slate-100 shadow-[0_15px_30px_-5px_rgba(0,0,0,0.03)] space-y-5">
            <div className="flex items-center gap-3.5">
              <div className="w-13 h-13 rounded-2xl bg-slate-50 border border-slate-100 text-rose-600 flex items-center justify-center shrink-0 p-3">
            ...
            <p className="text-sm sm:text-base text-slate-600 leading-relaxed">
              Thay vì nói: <em className="text-rose-700 font-semibold">"Ngành này khó lắm, con không theo nổi đâu"</em>, ba mẹ có thể khơi gợi để lắng nghe suy nghĩ của con bằng 3 câu hỏi ấm áp sau:
            </p>

            <div className="space-y-3">
              <div className="p-4 sm:p-5 rounded-2xl bg-slate-50 border border-slate-200/90 flex items-start gap-3.5">
                ...
                <span className="text-sm sm:text-base text-slate-800 font-medium italic leading-relaxed">
            ...
            <div className="p-4 sm:p-5 rounded-2xl bg-rose-50/60 border border-rose-200 text-sm sm:text-base text-rose-950 flex items-start gap-3">
              <Heart size={22} weight="fill" className="text-rose-600 shrink-0 mt-0.5" />
              <div className="leading-relaxed">
        ...
        <div className="bg-slate-900 text-white rounded-[2rem] p-6 sm:p-8 shadow-xl space-y-4">
          <div className="flex items-center gap-3">
            <div className="w-11 h-11 rounded-2xl bg-blue-600/30 text-blue-400 flex items-center justify-center shrink-0">
          ...
          <div className="space-y-3">
            <textarea
              ...
              className="w-full bg-slate-800/80 text-white text-sm sm:text-base rounded-2xl p-4 border border-slate-700 outline-none focus:border-blue-500 transition-colors leading-relaxed"
            />

            <div className="flex flex-wrap items-center justify-between gap-3">
              <button
                onClick={handleCopyReply}
                className={`inline-flex items-center gap-2.5 px-6 py-3 rounded-xl font-bold text-xs sm:text-sm transition-all shadow-md ${
                  copiedResponse
              ...
              >
                {copiedResponse ? (
                  <>
                    <Check size={20} weight="bold" /> Đã sao chép tin nhắn
                  </>
                ) : (
                  <>
                    <Copy size={20} weight="bold" /> Sao chép lời nhắn gửi qua Zalo
                  </>
                )}
              </button>
        ...
        {/* Footer Disclaimer */}
        <div className="text-center py-5 text-xs sm:text-sm text-slate-400 space-y-1.5">
          <p>
            © 2026 FutureTrace • Hệ thống tư vấn & mô phỏng định hướng học tập và sự nghiệp thông minh.
          </p>
          <p className="text-xs text-slate-400">
            * Toàn bộ dữ liệu mô phỏng nhằm mục đích tham khảo, khuyến khích sự lắng nghe và đối thoại cởi mở trong gia đình.
          </p>
        </div>
      </main>
    </div>
