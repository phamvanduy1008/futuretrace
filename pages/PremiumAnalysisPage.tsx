...
const PremiumAnalysisPage: React.FC = () => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center text-white font-sans p-6 overflow-hidden">
        <div className="relative w-40 h-40 mb-10">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <span className="material-symbols-outlined text-amber-500 text-4xl animate-pulse">workspace_premium</span>
          </div>
        </div>
        <h2 className="text-xl font-black uppercase tracking-[0.4em] mb-4 text-amber-500">Phân tích Chuyên sâu Premium</h2>
        <p className="text-slate-500 text-[10px] font-black uppercase tracking-[0.3em] animate-pulse">Hệ thống đang giả lập lộ trình phức hợp...</p>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-[#f8fafc] flex flex-col font-sans">
      ...
      <main className="flex-1 max-w-[1200px] mx-auto w-full px-6 py-12 sm:py-20">
        <header className="mb-20 relative">
          <div className="flex items-center gap-3 text-[10px] font-black text-amber-600 uppercase tracking-[0.4em] mb-8">
            <span className="material-symbols-outlined text-[16px]">workspace_premium</span> BÁO CÁO PHÂN TÍCH ĐẶC QUYỀN
          </div>
          ...
          <div className="p-10 bg-white border border-slate-100 rounded-[3rem] shadow-[0_40px_100px_-20px_rgba(0,0,0,0.08)] relative overflow-hidden group">
            <div className="absolute top-0 right-0 p-12 opacity-5 pointer-events-none">
               <span className="material-symbols-outlined text-[180px] text-slate-900">auto_awesome</span>
            </div>
            <h3 className="text-[10px] font-black uppercase tracking-[0.3em] text-blue-600 mb-6 flex items-center gap-3">
               <span className="material-symbols-outlined text-lg">history_edu</span> Diễn biến chi tiết (Narrative)
            </h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 mb-20">
           ...
           <div className="lg:col-span-8 space-y-10">
              <section className="bg-slate-950 p-10 sm:p-14 rounded-[3rem] text-white shadow-2xl relative overflow-hidden">
                <h3 className="text-[10px] font-black uppercase tracking-[0.3em] text-amber-400 mb-12">Cột mốc chiến lược (Milestones)</h3>
              ...
              <section className="bg-white p-10 sm:p-14 rounded-[3rem] border border-slate-100 shadow-[0_30px_60px_-15px_rgba(0,0,0,0.05)]">
                 <h3 className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-900 mb-10 flex items-center gap-3">
                   <span className="material-symbols-outlined text-blue-600">alt_route</span> Điểm xoay chiến lược (Pivot Points)
                 </h3>
                    ...
                    {report.strategicPivotPoints.map((p, i) => (
                      <div key={i} className="p-8 bg-slate-50 rounded-[2rem] border border-slate-100 group hover:bg-slate-900 transition-all shadow-sm hover:shadow-xl">
                        <div className="w-10 h-10 bg-white rounded-xl flex items-center justify-center mb-6 shadow-sm group-hover:bg-white/10">
                           <span className="material-symbols-outlined text-blue-600 group-hover:text-white text-xl">help_outline</span>
                        </div>
                        <p className="text-[9px] font-black uppercase tracking-widest text-slate-400 mb-2 group-hover:text-slate-500">Nếu xảy ra:</p>
           ...
           <div className="lg:col-span-4 space-y-10">
              <section className="bg-white p-10 rounded-[3rem] border border-slate-100 shadow-[0_30px_60px_-15px_rgba(0,0,0,0.05)]">
                 <h3 className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-900 mb-10">Nhân tố ảnh hưởng</h3>
                 <div className="space-y-8">
                    {report.influencingFactors.map((f, i) => (
                      <div key={i} className="space-y-3">
                         ...
                         <p className="text-xs text-slate-500 leading-relaxed font-medium italic opacity-80">{f.description}</p>
                      </div>
                    ))}
                 </div>
              </section>
              ...
              <section className="bg-slate-900 p-10 rounded-[3rem] text-white shadow-2xl relative overflow-hidden border border-slate-800">
                 ...
                 <h3 className="text-[10px] font-black uppercase tracking-[0.3em] text-blue-400 mb-8">Viễn cảnh dài hạn (3-5 năm)</h3>
              ...
              <div className="flex flex-col gap-4">
                 <button onClick={() => window.print()} className="w-full py-5 bg-blue-600 text-white font-black text-[11px] uppercase tracking-[0.3em] rounded-2xl hover:bg-blue-700 shadow-xl shadow-blue-500/20 transition-all flex items-center justify-center gap-3">
                    XUẤT BÁO CÁO (.PDF) <span className="material-symbols-outlined text-lg">download</span>
                 </button>
                 <button onClick={() => navigate(-1)} className="w-full py-5 bg-white border border-slate-200 text-slate-500 font-black text-[11px] uppercase tracking-[0.3em] rounded-2xl hover:bg-slate-50 transition-all shadow-sm">
                    QUAY LẠI TỔNG QUAN
                 </button>
              </div>
           </div>
          ...
          <div className="fixed inset-0 z-[200] flex items-center justify-center p-6">
            ...
            >
              <div className="p-8 sm:p-10 border-b border-slate-100 bg-slate-50/50 flex items-center justify-between">
                <div>
                   <span className="text-[10px] font-black text-blue-600 uppercase tracking-[0.4em] mb-2 block">CHI TIẾT THỰC THI</span>
              ...
              <div className="p-8 sm:p-10 max-h-[50vh] overflow-y-auto">
                ...
                <div className="space-y-6">
                  <h4 className="text-[10px] font-black text-slate-900 uppercase tracking-widest flex items-center gap-3">
                    <span className="material-symbols-outlined text-blue-600 text-lg">tips_and_updates</span> HƯỚNG DẪN CỤ THỂ:
                  </h4>
              ...
              <div className="p-8 sm:p-10 border-t border-slate-50 flex justify-end gap-6 bg-slate-50/20">
                 ...
                 {selectedMilestoneIndex !== null && getMilestoneStatus(selectedMilestoneIndex) === 'Đang tiến hành' && (
                   ...
                   >
                     <span className="material-symbols-outlined text-lg">check_circle</span> Đánh dấu hoàn thành
                   </button>
                 )}
                 {selectedMilestoneIndex !== null && getMilestoneStatus(selectedMilestoneIndex) === 'Đã hoàn thành' && (
                   <div className="px-10 py-4 bg-slate-100 text-emerald-600 rounded-2xl font-black text-[10px] uppercase tracking-widest flex items-center gap-2">
                     <span className="material-symbols-outlined text-lg">verified</span> Đã hoàn thành
                   </div>
                 )}
              </div>
            </motion.div>
        ...
        {isPivoting && (
          <div className="fixed inset-0 z-[300] flex flex-col items-center justify-center bg-slate-950/90 backdrop-blur-xl text-white">
            <div className="relative w-32 h-32 mb-10">
              ...
              ></motion.div>
              <div className="absolute inset-0 flex items-center justify-center">
                <span className="material-symbols-outlined text-blue-500 text-4xl animate-pulse">refresh</span>
              </div>
            </div>
            <h2 className="text-xl font-black uppercase tracking-[0.4em] mb-4 text-blue-500">Đang điều chỉnh lộ trình</h2>
            <p className="text-slate-500 text-[10px] font-black uppercase tracking-[0.3em] animate-pulse">AI đang phân tích feedback và tối ưu các cột mốc tiếp theo...</p>
          </div>
        )}
      </AnimatePresence>
          ...
          <div className="fixed inset-0 z-[250] flex items-center justify-center p-6">
            ...
            <motion.div initial={{ opacity: 0, scale: 0.9, y: 30 }} animate={{ opacity: 1, scale: 1, y: 0 }} exit={{ opacity: 0, scale: 0.9, y: 30 }} className="relative w-full max-w-lg bg-white rounded-[3rem] p-10 shadow-2xl border border-slate-100">
              <div className="text-center mb-10">
                ...
                <p className="text-slate-500 text-sm font-medium">Bạn có gặp khó khăn gì hay vấn đề gì hoặc đã gặp phải kết quả không mong muốn nào không?</p>
              </div>
              ...
              <div className="flex flex-col gap-4">
                <button 
                  ...
                  className="w-full py-5 bg-slate-900 text-white font-black text-[11px] uppercase tracking-[0.3em] rounded-2xl hover:bg-blue-600 disabled:bg-slate-100 disabled:text-slate-400 transition-all shadow-xl"
                >
                  Gửi phản hồi <span className="material-symbols-outlined text-lg">send</span>
                </button>
                <button 
          ...
          <div className="fixed inset-0 z-[250] flex items-center justify-center p-6">
            ...
            <motion.div initial={{ opacity: 0, scale: 0.9, y: 30 }} animate={{ opacity: 1, scale: 1, y: 0 }} exit={{ opacity: 0, scale: 0.9, y: 30 }} className="relative w-full max-w-lg bg-white rounded-[3rem] p-10 shadow-2xl border border-slate-100">
              <div className="text-center mb-10">
                ...
                <p className="text-slate-500 text-sm font-medium leading-relaxed">Bạn có đồng ý để chúng tôi đưa ra các phương án mới hơn phù hợp với trường hợp của bạn không?</p>
              ...
              <div className="flex flex-col gap-4">
                <button 
                  ...
                  className="w-full py-5 bg-amber-600 text-white font-black text-[11px] uppercase tracking-[0.3em] rounded-2xl hover:bg-amber-700 shadow-xl shadow-amber-200 transition-all"
                >
                  Đồng ý & Cập nhật <span className="material-symbols-outlined text-lg">bolt</span>
                </button>
                <button 
